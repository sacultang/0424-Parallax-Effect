...
},{"./debounce":"node_modules/lodash/debounce.js","./isObject":"node_modules/lodash/isObject.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var scrollReveal = function scrollReveal() {
  ...
  var scrollTop = window.scrollY || document.documentElement.scrollY;
  console.log(scrollTop);
  reveal.forEach(function (element) {
    var revealDelay = element.dataset.delay; // if (scrollTop > element.parentElement.offsetTop - 500) {
...
window.addEventListener('scroll', (0, _throttle2.default)(scrollReveal, 200));
